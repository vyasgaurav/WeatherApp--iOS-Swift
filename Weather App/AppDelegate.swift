...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func getCurrentViewController(_ controller: UIViewController?) -> UIViewController? {
        if let controller = controller as? UINavigationController {
            if let lastViewcontroller = controller.viewControllers.last {
                return getCurrentViewController(lastViewcontroller)
            }
        }
